define("Tasks_FormPage", /**SCHEMA_DEPS*/["@creatio-devkit/common"]/**SCHEMA_DEPS*/, function/**SCHEMA_ARGS*/(sdk)/**SCHEMA_ARGS*/ {
	return {
		viewConfigDiff: /**SCHEMA_VIEW_CONFIG_DIFF*/[
			...
			{
				"operation": "merge",
				"name": "ExpansionPanelMeetingTranscripts",
				"values": {
					"toggleType": "material"
				}
			},
			...
			},
			{
				...
				"parentName": "FlexContainer_8t3ar36",
				"propertyName": "items",
				"index": 0
			},
			{
			...
			},
			{
				...
				"values": {
					...
					"tools": [],
					"items": [],
					"title": "#ResourceString(ExpansionPanel_17p0x4t_title)#",
					"toggleType": "material",
					"togglePosition": "before",
					"expanded": true,
					"labelColor": "auto",
			...
			},
			{
				...
				"parentName": "ExpansionPanel_17p0x4t",
				"propertyName": "tools",
				"index": 0
			},
			{
				"operation": "insert",
				"name": "FlexContainer_duj53js",
				"values": {
					"type": "crt.FlexContainer",
					"direction": "row",
					"gap": "none",
				...
				"parentName": "GridContainer_pdp6w3v",
				"propertyName": "items",
				"index": 0
			},
			{
				"operation": "insert",
				"name": "GridContainer_hxx4e00",
				"values": {
					"type": "crt.GridContainer",
					"rows": "minmax(max-content, 32px)",
					"columns": [
			...
			},
			{
				...
				"parentName": "GridContainer_hxx4e00",
				"propertyName": "items",
				"index": 0
			},
			{
